...
async function aequitas(rows) {
  ...
  const baseUri = 'https://www.cboe.ca/en/live/security-activity';
      ...
      await page
        ...
        .then(() => {
          return Promise.all([
            page
              .locator(
                '#security-summary-table > tbody > tr:nth-child(1) > td:nth-child(2)'
              )
              .evaluate((node) => node.innerText),
            page
              .locator(
                '#securityDetails > div:nth-child(2) > span:nth-child(4) > strong'
              )
              .evaluate((node) => node.innerText),
          ]);
        })
